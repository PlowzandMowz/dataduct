# -*- coding: utf-8 -*-
#
# dataduct documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../dataduct'))
...
latex_documents = [
  ('index', 'dataduct.tex', u'dataduct Documentation',
   u'Coursera', 'manual'),
]
